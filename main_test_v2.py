...
EXPERIMENT_DIR = "simulations/train/run_2026-04-19_14-11-34/"
...
def main(start_date, end_date) -> None:
    ...
    app_config = AppConfig.load_from_train_config(
        path=f"{EXPERIMENT_DIR}/config.json", start_date=start_date, end_date=end_date)
...
if __name__ == "__main__":
    until_date = "2024-01-0"
    # for i in range(2,5):
    i = 2
    j = 4
    # print(until_date+str(i), until_date+str(i+j))
    # main(until_date+str(i), until_date+str(i+j))

    main("2024-03-01", "2025-03-01")